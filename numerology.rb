#Under each number i commented what i was attempting, to show my train of thought.

  # Numerology App
 
# 1. ask the user for their birthdate
puts "What is your birthdate? Please write it like this: MMDDYYYY"
# - what I did #puts "Hello, what is your date of birth my child? ddmmyyyy"
...
#number = birthdate + birthdate etc
...
#birthpath_number = number + birthdate
...
#case 'numerology_no'
#if '1'
  #puts "One is the leader. The number one indicates the ability to stand alone, and is a strong vibration. Ruled by the Sun. Do one!"
#elsif '2'
